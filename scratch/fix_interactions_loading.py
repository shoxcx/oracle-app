...
# 1. Fixed Close button using window.ipcRenderer.invoke('window:hide').
# 2. Reduced card height to aspect-[3/5] to avoid bottom crop.
# 3. Improved draggable area (larger header zone).
...
print("Loading Screen Interactions Fixed")
