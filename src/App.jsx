...
const translations = {
  en: {
    ...
    // Items
    dashboard: "Dashboard", tierlist: "Tierlist & Builds", leaderboards: "Leaderboards",
  ...
  fr: {
    cat_core: "ORACLE CORE", cat_app: "ORACLE APP", cat_insights: "ORACLE INSIGHTS",
    dashboard: "Tableau de bord", tierlist: "Tierlist & Builds", leaderboards: "Classements",
    replays: "Replays", overlays: "Overlays", collections: "Collections",
    esports: "Esports", datastudio: "Data Studio", matchups: "Matchups",
  ...
  es: {
    cat_core: "ORACLE CORE", cat_app: "ORACLE APP", cat_insights: "ORACLE INSIGHTS",
    dashboard: "Resumen", tierlist: "Tierlist & Builds", leaderboards: "ClasificaciÃƒÂ³n",
  ...
  pt: {
    ...
    cat_core: "ORACLE CORE", cat_app: "ORACLE APP", cat_insights: "ORACLE INSIGHTS",
    dashboard: "VisÃƒÂ£o Geral", tierlist: "Tierlist & Builds", leaderboards: "Rankings",
  ...
  ru: {
    ...
    cat_core: "ORACLE CORE", cat_app: "ORACLE APP", cat_insights: "ORACLE INSIGHTS",
    dashboard: "Obzor", tierlist: "Tierlist & Builds", leaderboards: "Reytingi",
...
function DashboardView({ t, panelClass, currentUser, targetSummoner, ddragonVersion, patchNotes, setActiveTab, setTargetChamp, onOpenUrl, onSearch }) {
  ...
  const stats = useMemo(() => {
    const base = {
      kda: "0.0", wr: "0%", csm: "0.0", kp: "0", vision: "0", gpm: "0", oracle: "0",
      wins: 0, count: 0, losses: 0, goldDiff: "0", kaDiff: "0",
      history: { kda: [], oracle: [], kp: [], csm: [], vision: [], gpm: [], gold: [], ka: [] }
    };
    ...
    [...recentGames].reverse().forEach(g => {
      ...
      if (opponent) {
        ...
        totalKaDiff += (myKa - opKa);
        hist.ka.push(myKa - opKa);
